...
and therefore can be arbitrarily heavy with mass matrix $M_R$~\cite{Mohpatra1979}.
...
from \gesix, $^{130}$Te and $^{136}$Xe is given in \cref{tab:nbb:0nbb-lim}.
The experimental program to search for \onbb\ decay is presented more in detail in
\cref{sec:nbb:exp}.
