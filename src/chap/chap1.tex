...
(Majoron emission, Lorentz symmetry violation) are given. \fillme{expand}
...
\partitle{experimental \\ limits}
Here a compilation of the current experimental bounds is given in \cref{tab:nbb:0nbbx-lim}.
...
\begin{description}[wide]
  ...
  \item[Scintillators] The main appeal of organic scintillators for \onbb\
    ...
    resolution in the KamLAND2-Zen experiment. Searching \onbb\ decay with
    ...
    the source isotope~\cite{Paton2019}. Also inorganic CaF$_2$
