...
\begin{table}
  ...
  \caption{%
    ...
    publications~\cite{Agostini2013a, Agostini2018a}. \fillme{exposures}
...
\begin{sidewaystable}
  ...
  \caption{%
    ...
    ($\,^{\dagger}$ Tetratex\reg-coated) \fillme{why \kvz\ on \nplus (BEGe) is non-zero in
    this table?}
...
$1\sigma$.\footnote{%
  The systematic bias between the active volume estimates for the \bege\ and coaxial
...
\begin{figure}
  ...
  \caption{%
    ...
    analysis before and after the \phasetwop\ hardware upgrade. \fillme{exposures}
...
\begin{figure}
  ...
  \caption{%
    Background decomposition of the full \gerdatwo\ data set.
...
\begin{itemize}
  ...
  \item The obtained model describes the data and reproduces the screening measurement
    results to a satisfying degree of accuracy.
\end{itemize}
% vim: tw=90
