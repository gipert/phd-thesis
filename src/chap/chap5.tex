...
indeed, satisfactory enough (c.f.r.~\cref{fig:bkg:lar:ph2:results-closeup}), and the
...
\begin{description}
  ...
  \item[Theoretical \nnbb\ decay model] The theoretical calculations of the \nnbb\
    ...
    % however there is no guarantee that the impact on the current analysis
...
\begin{table}
  ...
  \caption{%
    ...
    distribution. \fillme{numbers here}
