...
\enrCoaxII\ and \enrGeII\ data sets is also not used in the present analysis.
\newpar
...
\begin{equation}\label{eq:2nbb-ana:halflife}
  \thalftwoM = \frac{\mathcal{C}_{76}}{S}\;;\quad
...
assumption modifies the distribution of the test statistic (right panel). In the large
...
\begin{figure}
  ...
  \caption{%
    ...
    uncertainties is included. \fillme{Update, reference in text}
...
\[
  S_\nnbblvM \in [0,0] \;,
\]
over a best-fit number of standard \nnbb\ events of \fillme{?}. The corresponding
