...
\begin{table}
  ...
  \caption{%
    ...
    most recent nuclear calculations. Matrix elements for the other decay modes have been
    taken from~\cite{Hirsch1995}. Phase space factors have been taken
    from~\cite{Kotila2015}. Results for \ga\ for two-Majoron modes include the uncertainty
...
compared to \phaseone, this degree of enhancement expected, since the limits are dominated
...
for all the others) it is possible to convert the half-life limit into an upper limit on
