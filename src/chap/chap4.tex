...
$\sim$~20 (\fillme{cross-check with betta}). This large background reduction motivates the
...
and \cref{tab:bkg:lar:ph2:results} (\fillme{table if I have time}). The background
...
fit is not satisfactory through all the spectrum. In particular, discrepancies between the
best-fit model and the data are visible in \enrGeII\ right below the potassium peaks,
...
\fillme{update to final fit results}
...
\fillme{discuss about transition layer models}
