...
\begin{table}
  ...
  \caption{%
    ...
    runs~68 (July 2016, \Th\ source) and 76 (February 2017, \Ra\ source). The random
...
($-2\Delta\log\mathcal{L}=10$ \fillme{check this}) at the best fit point is around 30\%, which already shows
