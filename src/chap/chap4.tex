...
\cref{fig:bkg:lar:ph2:pdfs:gmodel}. \fillme{any comment?}
...
The pdf extracted from the \a\ model presented in \cref{sec:bkg:raw:ph2:amodel} can be
therefore used in the full-range analysis as it is. The potassium tracking analysis has
not been repeated too. The full-energy spectrum has been therefore analysed in its entire
range from 565~keV to 5260~keV.
