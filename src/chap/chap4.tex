...
normalization) cannot be fully trusted, no priors from screening measurement data have
been set. \fillme{explain this better maybe somewhere else?} A uniform prior is assigned
to all fit parameters (including the \nnbb\ fit parameter, which is proportional to
$1/\thalftwoM$).
...
transition layer model, which significantly affects the pdf shape above the FEP. The \b\
spectrum component above 1525~keV, indeed, is now higher and shows less compatibility with
