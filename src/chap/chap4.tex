...
already low before the cut (c.f.r.~\cref{tab:bkg:raw:ph2:gmodel:results}). Nevertheless,
...
before the LAr veto cut (c.f.r.~\cref{sec:bkg:raw:ph2:gmodel}), where the statistics is
