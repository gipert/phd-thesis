...
\begin{figure}
  ...
  \caption{%
    ...
    detectors in the central string in the \phasetwop\ configuration. \fillme{different
...
LAr veto system. The calibration of the experimental setup is extensively described in
ref.~\fillme{[fillme]}.
