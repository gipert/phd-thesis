...
following, ended in December 2019 after collecting the total exposure of \fillme{fillme}~\kgyr\
...
(the latter experiment searching for \onbb\ with germanium detectors in \fillme{fillme}, USA),
...
currently in commissioning phase. \fillme{LEGEND-1000}.
...
\cref{sec:gerda:setup} a general overview of the apparatus is given \fillme{fillme}.
...
surface. To match the fibers and PMTs \fillme{fillme} spectra many surfaces in the close vicinity
...
usually switched off because of the too high source activity \fillme{how much?}. The calibration of
the experimental setup is extensively described in ref.~[\fillme{fillme}].

Each event has to pass a series of quality cuts tailored to discard unphysical events,
which is extensively described in [\fillme{fillme}].
