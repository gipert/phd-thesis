...
voltage biasing are then fabricated on the detector surface. The n+ contact, where the
...
(FCCD). The p+ electrode, where the signal is read out, is instead fabricated by boron
...
bore-hole makes this kind of detectors harder to fully deplete, requiring lower impurity
