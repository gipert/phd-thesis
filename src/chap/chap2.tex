...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{plots/0nbb-results/calib-desc.pdf}
  \caption{%
    A typical \Th\ calibration spectrum from \bege, semi-coaxial and inverted-coaxial
    detectors, respectively. The peaks used for determination of the calibration and
    resolution curves are highlighted. \fillme{superimpose the calibration curves to the
    plot}
