...
\begin{document}
  \begin{tikzpicture}
    \begin{groupplot}[
      ...
      \node at (axis cs:2016-10-01,0.11) {%
          \begin{tabular}{cl}
            \ref{bege-ph2}     & \textsc{BEGe} \\
            \ref{bege-fit-ph2} & $C + N \exp\frac{-\log2 t}{T_{1/2}}$ \\
          \end{tabular}
        };
      ...
      \addplot+[points, mark=triangle*] table [x=time, y=cts, y error=err] {amodel-timealpha-invCoax.csv};
      \label{inv-ph2}
      ...
      \node at (axis cs:2016-12-01,1.1) {%
          \begin{tabular}{cl}
            \ref{coax-ph2}     & \textsc{SemiCoax} \\
            \ref{inv-ph2}      & \textsc{InvCoax} \\
            \ref{coax-fit-ph2} & $C + N \exp\frac{-\log2 t}{T_{1/2}}$ \\
          \end{tabular}
        };
