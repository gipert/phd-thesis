...
// ("long", 1 panel plots)
{
    ...
    gerdaStyle->SetPadBottomMargin(0.13);
    gerdaStyle->SetPadTopMargin(0.011);

    // default canvas size
    gerdaStyle->SetCanvasDefH(550);
    gerdaStyle->SetCanvasDefW(1500);
    ...
    gerdaStyle->SetTitleFont(font, "XY");
    gerdaStyle->SetTitleXSize(fontsize);
    gerdaStyle->SetTitleYSize(fontsize);
    gerdaStyle->SetTitleOffset(1.1, "X");
    gerdaStyle->SetTitleOffset(0.4, "Y");

    // ticks
    gerdaStyle->SetTickLength(0.007, "Y");
