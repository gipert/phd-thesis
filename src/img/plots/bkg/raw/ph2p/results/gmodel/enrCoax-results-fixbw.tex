...
\begin{document}
  \begin{tikzpicture}
    \begin{groupplot}
      ...
      \pgfplotstableread{data/originals/gerda_data_bkgmodel_phaseIIplus_v07_00_raw_M1_enrCoax.csv}\loadedtable;
      ...
      \node[anchor=north east] at (axis description cs:0.98,0.93) {\textsc{SemiCoax} -- 13.2 kg$\cdot$yr};
