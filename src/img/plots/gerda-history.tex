...
\begin{document}
  \begin{tikzpicture}
    ...
    \begin{axis}[
      ...
      % sensitivities
      \addplot+[thalf, mark=triangle*] coordinates {
        (2013-05-01, 2.4E25)
        (2016-06-01, 4.0E25)
        (2017-04-01, 5.8E25)
        (2018-04-01, 11E25)
      ...
      \node[publabel] at (axis cs:2018-04-01, 1.13E26) {\sc Science 365 1445};
    \end{axis}
  \end{tikzpicture}
\end{document}
