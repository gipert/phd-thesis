...
label("\texttt{C2}", (cs_pos_radius*cos(pi*5/6),cs_pos_radius*sin(pi*5/6),170));
draw(shift(cs_pos_radius*cos(pi*5/6),cs_pos_radius*sin(pi*5/6),0) * calib_source,
     surfacepen=cs_material);

// string 4
label("\texttt{S4}", (-110-17,0+17,170));
