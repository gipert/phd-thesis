...
// string 1
draw_label("S1", 110, 0);
GD91A.draw(pos=(110,0,78.59));
GD35B.draw(pos=(110,0,24.05));
GD02B.draw(pos=(110,0,-31.17));
GD00B.draw(pos=(110,0,-85.77));
GD61A.draw(pos=(110,0,-142.22));
GD89B.draw(pos=(110,0,-200.08));
GD02D.draw(pos=(110,0,-253.55));
GD91C.draw(pos=(110,0,-307.61));
...
IC48A.draw(pos=(0.00,0.00,-55.8));
IC50A.draw(pos=(0.00,0.00,-157.3));
