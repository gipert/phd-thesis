...
% FIXME: jlcode breaks math font
% \usepackage[usebox=false, autoload=false]{tex/jlcode} % this must be loaded before unicode-math
\lstset{%
  % language=julia,
  style=FiraCodeStyle,
  % style=jlcodestyle,
...
\usepackage[lining]{ebgaramond} % this must be loaded after
% \usepackage{lettrine}
