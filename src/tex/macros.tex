...
\newcommand{\thalftwovalue}{(2.050 \pm \stat{0.011} \pm \syst{0.042}) \cdot 10^{21}}
\newcommand{\thalftwovalueshort}{(2.050 \pm 0.044) \cdot 10^{21}}
\newcommand{\thalfmajobestlimit}{6.8 \cdot 10^{23}}
...
% isotopes
\ifcsname{textsu}\endcsname
  \newcommand{\nuc}[2]{\textsu{#2}{\textnormal{#1}}}
\else
  \newcommand{\nuc}[2]{\textsuperscript{#2}{\textnormal{#1}}}
\fi
