...
\begin{frame}{Wrapping up}
  \begin{columns}
    ...
    \begin{column}{0.36\textwidth}
      \vspace*{1.6cm} \\
      \fbox{\includegraphics[width=4.5cm,clip,trim=0 0 0 0]{jhep-paper.png}}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}[label=compile]{Motivations}
  ...
  \end{alertblock}
\end{frame}
\begin{frame}[label=compile]{Analysis strategy}
  \begin{description}
...
\begin{frame}[label=compile]{bla}
  ...
  \end{itemize}
\end{frame}
\begin{frame}[label=compile]{Inclusion of systematic uncertainties}
  \begin{columns}
    \begin{column}{0.55\textwidth}
  ...
  \end{columns}
\end{frame}
\begin{frame}[label=compile]{LAr veto model uncertainties}
  \begin{columns}
...
\begin{frame}[label=compile]{\texorpdfstring{\nnbb}{2νββ} theoretical shape uncertainties}
  ...
  \end{columns}
\end{frame}
\begin{frame}[label=compile]{Other systematic uncertainties}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
  ...
  \end{columns}
\end{frame}
\begin{frame}[label=compile]{Results: \texorpdfstring{\nnbb}{2νββ} half-life}
  \begin{simpleblock}
    \[
  ...
  \end{itemize}
\end{frame}
\begin{frame}[label=compile]{Results: Majoron-emitting \texorpdfstring{\onbb}{0νββ}}
  \begin{center}
    \footnotesize
  ...
  \begin{itemize}
    ...
    \item About a factor of 2 better than previous results\footnote{Compared to
      \phaseone\ analysis \href{https://doi.org/10.1140/epjc/s10052-015-3627-y}{Eur.~Phys.~J.~C 75, 416 (2015)}}
    \item Comparable to \nuc{Xe}{136} constraints, a factor 10 better for $n=7$
    \item New \gesix\ NMEs and phase-space factors from J.~Kotila and F.~Iachello
  \end{itemize}
\end{frame}
\begin{frame}[plain,label=compile]{Results: Majoron-emitting \texorpdfstring{\onbb}{0νββ}}
  \begin{center}
    \includegraphics[height=0.95\textheight]{plots/2nbb-ana/enrBEGe-results.pdf}
  \end{center}
\end{frame}
\begin{frame}[label=compile]{Known issues and work in progress}
  \begin{itemize}
    \item Constrain more physics models (Lorentz violation, sterile neutrinos\ldots)
